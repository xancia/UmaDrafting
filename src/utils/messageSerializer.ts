 ...
 */
export function deserializeMessage<T = unknown>(
  json: string,
): NetworkMessage<T> {
  try {
 ...
 */
export function isDraftActionPayload(
  payload: unknown,
): payload is DraftActionPayload {
 ...
 */
export function isJoinRequestPayload(
  payload: unknown,
): payload is JoinRequestPayload {
  if (!payload || typeof payload !== "object") {
    return false;
  }
  ...
  return (
    (p.connectionType === "host" ||
      p.connectionType === "player" ||
      p.connectionType === "spectator") &&
 ...
 */
export function isJoinAcceptedPayload(
  payload: unknown,
): payload is JoinAcceptedPayload {
  if (!payload || typeof payload !== "object") {
    return false;
  }
  ...
  return p.roomState !== undefined && typeof p.yourId === "string";
}

/**
 * Type guard for JoinRejectedPayload
 */
export function isJoinRejectedPayload(
  payload: unknown,
): payload is JoinRejectedPayload {
  if (!payload || typeof payload !== "object") {
    return false;
  }
 ...
 */
export function isStateSyncPayload(
  payload: unknown,
): payload is StateSyncPayload {
  if (!payload || typeof payload !== "object") {
    return false;
  }
  ...
  return p.draftState !== undefined && typeof p.version === "number";
}
