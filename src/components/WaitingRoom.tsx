  ...
  return (
    <div className="h-screen bg-linear-to-br from-gray-950 to-gray-900 flex items-center justify-center px-4 lg:px-6">
      <div className="bg-gray-800 rounded-xl shadow-2xl p-6 lg:p-8 xl:p-10 border-2 border-gray-700 max-w-lg w-full text-center">
        <h1 className="text-2xl lg:text-3xl font-bold mb-1 lg:mb-2 text-gray-100">Waiting Room</h1>
        <p className="text-sm lg:text-base text-gray-400 mb-4 lg:mb-6 xl:mb-8">Share the room code with your opponent</p>

        {/* Room Code Display */}
        <div className="bg-gray-900 rounded-xl p-4 lg:p-6 mb-4 lg:mb-6 xl:mb-8 border border-gray-700">
          <p className="text-xs lg:text-sm text-gray-400 mb-1 lg:mb-2">Room Code</p>
          <button
          ...
          <p className={`text-xs mt-1 lg:mt-2 transition-colors ${copied ? 'text-green-400' : 'text-gray-500'}`}>
        ...
        <div className="grid grid-cols-2 gap-3 lg:gap-4 mb-4 lg:mb-6 xl:mb-8">
          <div className="bg-blue-900/20 border border-blue-700/50 rounded-lg p-3 lg:p-4">
            <p className="text-xs text-blue-400 mb-0.5 lg:mb-1">Team 1</p>
            <p className="font-semibold text-sm lg:text-base text-blue-300">{team1Name}</p>
          </div>
          <div className="bg-red-900/20 border border-red-700/50 rounded-lg p-3 lg:p-4">
            <p className="text-xs text-red-400 mb-0.5 lg:mb-1">Team 2</p>
            <p className="font-semibold text-sm lg:text-base text-red-300">{team2Name}</p>
          </div>
        </div>
        ...
        <div className="bg-gray-900/50 rounded-lg p-3 lg:p-4 mb-4 lg:mb-6 xl:mb-8 border border-gray-700">
          <div className="flex items-center justify-center gap-4 lg:gap-6">
            <div className="flex items-center gap-1.5 lg:gap-2">
              <span className={`w-2.5 lg:w-3 h-2.5 lg:h-3 rounded-full ${playerCount >= 2 ? 'bg-green-400' : 'bg-yellow-400 animate-pulse'}`} />
